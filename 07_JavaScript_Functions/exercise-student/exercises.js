 ...
 */
    ...
    function isAdmitted(gpa, satScore = 0, recommendation = true) {
            result = false;
 ...
 */
        ...
        //create a function that takes in an array
          function makeHappy(arr) {
            //append the word "Happy" at the beginning of each iteration
 ...
 */
        //create an address function that takes an array of objects
        function getFullAddressesOfProperties(address){
            //then map each item of the object
            let mailing = address.map((address)=>{
 ...
 */
        ...
        function findLargest(arr) {
            //use the forEach method to iterate through the 
